# -*- coding: utf-8 -*-
"""
ConvertModtranToExcel.py : python script to convert Modtran asciii file to excel
...
if __name__ == '__main__':
    ...
    excelfile_modtran = asciifile_modtran +".xlsx"
    print "Input Modtran file is ",asciifile_modtran
    print "Onput Modtran file is ",excelfile_modtran
    
    # read ascii file of Modtran with loadtape7
    read_modtrandata=loadtape7(asciifile_modtran,colSelect)
    
    #copy the Modtran data inside a pandas dataframe
    df = pd.DataFrame(read_modtrandata,columns=colSelect)
    
    print df.head()
    print df.tail()
    
    df.to_excel(excelfile_modtran)
    exit
